...
{
    public class MetagameEventMonitorTest : IClassFixture<MetagameEventMonitorFixture>
    {
        private readonly MetagameEventMonitorFixture _fixture;

        public MetagameEventMonitorTest(MetagameEventMonitorFixture fixture)
        {
            _fixture = fixture;
