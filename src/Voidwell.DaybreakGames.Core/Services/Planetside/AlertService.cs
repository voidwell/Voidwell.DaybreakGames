...
namespace Voidwell.DaybreakGames.Core.Services.Planetside
{
    public class AlertService : IAlertService
    {
        ...
        public async Task<AlertResult> GetAlertStats(int worldId, int instanceId)
        {
        ...
        public Task<Alert> GetAlert(int worldId, int instanceId)
        {
            return _alertRepository.GetAlert(worldId, instanceId);
        }

        public Task CreateAlert(Alert alertModel)
        {
            return _alertRepository.AddAsync(alertModel);
        }

        public Task UpdateAlert(Alert alertModel)
        {
            return _alertRepository.UpdateAsync(alertModel);
        }
        
        public Task<Alert> GetActiveAlert(int worldId, int zoneId)
        {
            return _alertRepository.GetActiveAlert(worldId, zoneId);
        }
    }
}
