...
{
    public class CharacterUpdaterProcessor : StatefulHostedService
    {
        ...
        public CharacterUpdaterProcessor(ICharacterUpdaterService characterUpdaterService, ICharacterService characterService,
            IOptions<AppOptions> options, ICache cache, ILogger<CharacterUpdaterProcessor> logger)
            : base(cache)
        {
        ...
        {
            var count = await _characterUpdaterService.GetQueueLengthAsync();
        ...
        private async void ExecuteAsync(object stateInfo)
        {
            ...
            var characterQueue = await _characterUpdaterService.GetAllAsync(TimeSpan.FromHours(1));
        ...
        private async Task UpdateCharacter(CharacterUpdateQueue characterItem)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    await _characterUpdaterService.RemoveAsync(characterItem);
                }
