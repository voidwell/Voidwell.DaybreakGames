...
namespace IdentityModel.Client
{
    ...
    public class CustomTokenClient : IDisposable
    {
        ...
        public CustomTokenClient(string address)
        ...
        /// </exception>
        public CustomTokenClient(string address, HttpMessageHandler innerHttpMessageHandler = null)
        {
        ...
        /// <param name="innerHttpMessageHandler">The inner HTTP message handler.</param>
        public CustomTokenClient(string address, string clientId, HttpMessageHandler innerHttpMessageHandler = null, AuthenticationStyle style = AuthenticationStyle.PostValues)
        ...
        public CustomTokenClient(string address, string clientId, string clientSecret, HttpMessageHandler innerHttpMessageHandler = null, AuthenticationStyle style = AuthenticationStyle.BasicAuthentication)
        ...
        /// <returns></returns>
        public virtual async Task<TokenResponse> RequestAsync(IDictionary<string, string> form, CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns></returns>
        public Task<TokenResponse> RequestClientCredentialsAsync(string scope = null, object extra = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return RequestAsync(Merge(fields, extra), cancellationToken);
        }
