...
namespace Voidwell.DaybreakGames.Messaging
{
    public class MessageService : IMessageService
    {
        ...
        public MessageService(IAuthenticatedHttpClientFactory authenticatedHttpClientFactory, IZoneService zoneService, IWorldService worldService, IOptions<MessagingOptions> options)
        {
