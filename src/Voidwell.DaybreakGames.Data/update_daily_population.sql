...
BEGIN
        ...
        INSERT INTO daily_population ("date", "world_id", "vs_count", "nc_count", "tr_count", "ns_count", "vs_avg_play_time", "nc_avg_play_time", "tr_avg_play_time", "ns_avg_play_time", "avg_play_time")
                SELECT
                        ...
                        COUNT(DISTINCT(CASE WHEN c."faction_id" = 4 THEN d."character_id" END)),
                        ...
                        COALESCE(AVG(CASE WHEN c."faction_id" = 4 THEN d."duration" END), 0),
        ...
        ON CONFLICT ("date", "world_id") DO UPDATE
                SET ("vs_count", "nc_count", "tr_count", "ns_count", "vs_avg_play_time", "nc_avg_play_time", "tr_avg_play_time", "ns_avg_play_time", "avg_play_time") =
                (EXCLUDED."vs_count", EXCLUDED."nc_count", EXCLUDED."tr_count", EXCLUDED."ns_count", EXCLUDED."vs_avg_play_time", EXCLUDED."nc_avg_play_time", EXCLUDED."tr_avg_play_time", EXCLUDED."ns_avg_play_time", EXCLUDED."avg_play_time");
END; $function$
