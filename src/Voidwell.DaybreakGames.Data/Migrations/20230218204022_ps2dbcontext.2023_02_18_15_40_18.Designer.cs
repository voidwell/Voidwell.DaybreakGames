...
namespace Voidwell.DaybreakGames.Data.Migrations
{
    ...
    [Migration("20230218204022_ps2dbcontext.2023_02_18_15_40_18")]
    partial class ps2dbcontext2023_02_18_15_40_18
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voidwell.DaybreakGames.Data.Models.Planetside.CharacterDirective", b =>
                {
                    ...
                    b.HasIndex("CharacterId", "DirectiveTreeId")
                        .HasDatabaseName("i_x_character_directive_character_id_directive_tree_id");
            ...
            modelBuilder.Entity("Voidwell.DaybreakGames.Data.Models.Planetside.CharacterDirective", b =>
                {
                    b.HasOne("Voidwell.DaybreakGames.Data.Models.Planetside.CharacterDirectiveTree", null)
                        .WithMany("CharacterDirectives")
                        .HasForeignKey("CharacterId", "DirectiveTreeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_character_directive_character_directive_tree_character_id_dir");
                });

            modelBuilder.Entity("Voidwell.DaybreakGames.Data.Models.Planetside.CharacterDirectiveObjective", b =>
                {
                    b.HasOne("Voidwell.DaybreakGames.Data.Models.Planetside.CharacterDirective", null)
                        .WithMany("CharacterDirectiveObjectives")
                        .HasForeignKey("CharacterId", "DirectiveId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_character_directive_objective_character_directive_character");
                });

            modelBuilder.Entity("Voidwell.DaybreakGames.Data.Models.Planetside.CharacterDirectiveTier", b =>
                {
                    b.HasOne("Voidwell.DaybreakGames.Data.Models.Planetside.CharacterDirectiveTree", null)
                        .WithMany("CharacterDirectiveTiers")
                        .HasForeignKey("CharacterId", "DirectiveTreeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_character_directive_tier_character_directive_tree_character");
                });
            ...
            modelBuilder.Entity("Voidwell.DaybreakGames.Data.Models.Planetside.CharacterDirective", b =>
                {
                    b.Navigation("CharacterDirectiveObjectives");
                });

            modelBuilder.Entity("Voidwell.DaybreakGames.Data.Models.Planetside.CharacterDirectiveTree", b =>
                {
                    b.Navigation("CharacterDirectiveTiers");

                    b.Navigation("CharacterDirectives");
                });
